            ...
            <div className="relative z-10 w-full max-w-md" data-scroll data-scroll-speed="1">
                <div className="bg-white/5 backdrop-blur-2xl p-8 md:p-12 rounded-[2.5rem] shadow-2xl border border-white/10 relative overflow-hidden group">
                    ...
                    <div className="relative z-10">
                        <h1 className="text-4xl font-bold font-serif mb-2 text-white text-center">Create Account</h1>
                        <p className="text-gray-400 text-center mb-10 text-sm">Join the world of premium interiors</p>

                        <form onSubmit={handleSubmit} className="space-y-6">
                            <div className="space-y-2">
                                <label className="block text-xs font-bold text-furnworld-gold tracking-widest uppercase ml-1">Full Name</label>
                                <div className="relative group">
                                    <BsPerson className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-500 group-focus-within:text-furnworld-gold transition-colors" />
                                    <input
                                        type="text"
                                        name="fullName"
                                        value={formData.fullName}
                                        onChange={handleChange}
                                        className={`w-full pl-12 pr-4 py-4 rounded-2xl border ${errors.fullName ? 'border-red-500/50' : 'border-white/10'} bg-white/5 text-white focus:ring-2 focus:ring-furnworld-gold focus:border-transparent outline-none transition-all placeholder:text-gray-600`}
                        ...
                        <div className="mt-10 pt-8 border-t border-white/5 text-center">
                            <p className="text-gray-400 text-sm">
                                ...
                                <Link to="/login" className="ml-2 font-bold text-furnworld-gold hover:text-white transition-colors underline-offset-4 hover:underline">
                                    Log in
                                </Link>
                            </p>
                        </div>
